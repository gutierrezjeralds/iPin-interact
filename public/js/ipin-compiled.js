...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-088e949b", Component.options)
  } else {
    hotAPI.reload("data-v-088e949b", Component.options)
' + '  }
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-088e949b", module.exports)
  }
}
...
!function(t,e){ true?!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(13)], __WEBPACK_AMD_DEFINE_RESULT__ = function(i){return e(t,i)}.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),
    ...
    $.fn.uploadFile = function (options) {
        ...
        (function checkAjaxFormLoaded() {
            if ($.fn.ajaxForm) {
                ...
                if (s.showQueueDiv) obj.container = $("#" + s.showQueueDiv);else obj.container = $("<ul class='ajax-file-upload-container list-inline text-center'></ul>").insertAfter($(obj));
